        ...
        <React.Fragment>
            ...
            <div className="backGround">
                <div className = "container">
                    ...
                    <h3 className = "pt-7 pb-5 d-flex justify-content-center category">Ovos caipira</h3>
                    ...
                    <h3 className = "pt-7 pb-5 d-flex justify-content-center category">Ovos Brancos</h3>
                    <div className = "row d-flex justify-content-start align-items-start productBar pb-5">
                        <div className = "col-3">
                            <div className = "productContainer">
                                <h6 > Ovo branco</h6>
                    ...
                    <h3 className = "pt-7 pb-5 d-flex justify-content-center category">Ovos em pó</h3>
                    <div className = "row d-flex justify-content-start align-items-start productBar pb-5">
                        <div className = "col-3">
                            <div className = "productContainer">
                                <h6 > Ovo em Pó</h6>
